...
<html>
<head>
<title>Ransom.com | Admin manage enquiry</title>
...
{				?>		
						  <tr>
							<td width="120"><?php echo htmlentities($result->EnquiryId);?></td>
							<td width="50"><?php echo htmlentities($result->EnquiryName);?></td>
								<?php echo $result->EmailId;?></td>
							
							<td width="400"><?php echo htmlentities($result->EnquiryMessage);?></td>
							
								<td width="50"><?php echo htmlentities($result->EnquiryEmail);?></td>
