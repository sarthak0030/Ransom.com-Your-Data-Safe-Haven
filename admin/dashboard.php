...
<html>
<head>
<title>Ransom.com | Admin Dashboard</title>
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								...
								<?php $sql = "SELECT UserEmail from tblusers";
...
$cnt=$query->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3>Solutions</h3>
										<?php $sql1 = "SELECT GameId from tblgames";
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Issues Raised</h3>
												<?php $sql2 = "SELECT EnquiryId from tblenquiry";
