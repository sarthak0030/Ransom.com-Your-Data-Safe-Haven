#!/usr/bin/python3
"""
GUI program for LSB Steganography in Python
Requirements: PyQt5, OpenCV, NumPy, Crypography
Author: Sarthak Patil
GitHub: https://github.com/sarthak0030/
"""
...
class Ui_MainWindow(object):
        ...
        if input_path == '':
            ...
            if output_path == '':
                ...
                try:
                    ...
                    self.progressBar.setValue(int(loss))
    ...
    def setupUi(self, MainWindow):
        ...
        self.actionAbout.triggered.connect(
            lambda: self.displayMsg('About', 'Created by: Suman Adhikari\n\nGitHub: https://github.com/int-main'))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow",
                                      "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; color:#5500ff;\">Encode</span></p></body></html>"))
        self.label_2.setText(_translate("MainWindow",
                                        "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; color:#5500ff;\">Decode</span></p></body></html>"))
