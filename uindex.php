		...
		<main>
			<div class="content content--fixed">
				<header class="codrops-header">
					<a href="#"><img src="img\death.svg" alt="ransom.com"></a>
					<nav class="navbar">
					  <ul>
						...
						<nav class="navbar1">
							<img class="userimg" src="img/usericon.png" height="40px">
							<p>
								<span class= "usertxt">
									<?php  
			...
			<div class="content content--fixed">
				<button class="color-button" id="colorBtn"><a href="template/usolution.php">Get Started</a></button>
			</div>
